...
void TableWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->send_table_row((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TableWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TableWidget::send_table_row)) {
                *result = 0;
            }
        }
    }
...
void *TableWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_TableWidget.stringdata))
...
// SIGNAL 0
void TableWidget::send_table_row(int _t1)
{
